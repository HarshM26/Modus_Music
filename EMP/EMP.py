...
# def toStart():
    ...
    def recognize_emotion():
        ...
        eel.getemo(pred,emotions[max(set(predictions), key=predictions.count)])
        sys.exit()
        # eel.start("index.html",size = (500,500))
        # @eel.expose
        # def playLocal():   
        #     if emo_score == 0:
        #         # tune = mp.newMedia("F:/project 2/Emotion-based-music-player-master/dataset/angry/angry.mp3")
        #         # path of / the / song /angry.mp3
